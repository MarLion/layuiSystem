...
layui.config({
    ...
    var tableIns = table.render({
        elem: '#oneBonus', limit: 10, cellMinWidth: 80,
        url:base.apiUrl()+"/xuanleManager/xuanle1haoReferrerProfitList",
        method:'get',
        headers:{
        ...
        cols: [[ // 表头
            ...
            {field:'recordFigure',align: 'center',title:'金额（元）',width:150},
    ...
    function exportTable(paramter) {
        base.exportAjax({
            ...
            success:function (res) {
                //excel名
                var name =  "玄乐1号推荐人奖金-批量导出-"+new Date().format("yyyyMMddhhmm");
                //excel头部
