...
layui.config({
    ...
    var tableIns = table.render({
        ...
        url: base.apiUrl() + "/xuanleManager/xuanle1haoAccount",
        headers:{
        ...
        cols: [[ // 表头
            ...
            {field: 'investmentAssetsY', align: 'center',title: '投入资产'},
            {field: 'accumulativeEarningsY',align: 'center', title: '累计收益'},
            {field: 'yesterdayEarningsY',align: 'center', title: '昨日收益'},
            {field: 'validAssetsY',align: 'center', title: '有效资产'},
            {field: 'rateY',align: 'center', title: '个人利率'},
            {field: 'time', align: 'center',title: '有效计息天数'},
            {
        ...
        base.exportAjax({
            ...
            success:function (res) {
                ...
                var firstR= {loginName: '用户账号',
                    ...
                    areaName: '区域',
                    shopName: '门店',
                    investmentAssetsY: '投入资产',
                    accumulativeEarningsY: '累计收益',
