layui.config({
    ...
    $("#goCompany").on('click',function () {
        ...
        if(roleLevel==1||roleLevel==0){
            hrefUrl='html/finance/overView/peopleLoginNum/loginCompany/loginCompany.html?time='+ time
        }else if(roleLevel==2){
            hrefUrl='html/finance/overView/peopleLoginNum/ngCompanyArea/ngArea.html?time='+ time+'&deptId=1'+'&deptName=';
        }else if(roleLevel==3){
            hrefUrl='html/finance/overView/peopleLoginNum/ngCompanyShop/ngArea.html?time='+ time+'&deptId=1'+'&deptName=';
        }
        parent.tab.tabAdd({
            href:hrefUrl,
            title: roleName+'会员登陆情况'
        })
    });
    ...
    function select1(time){
        base.oldProjectAjax({
            ...
            data:'{"time":'+time+',"deptId":1,"type":3}',
    ...
    function ridgePovertyEchartsSearch() {
        ...
        base.oldProjectAjax({
            ...
            data:'{"deptId":1,"type":3,"begindate":'+begindate+',"enddate":'+enddate+'}',
            success:function (res) {
                var _obj = res.data;
                var names = [];
                var nums = [];
