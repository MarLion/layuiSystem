layui.config({
    ...
    table.on('tool(areaLs)', function (obj) {
        ...
        if (obj.event === 'goShopDetails') {
            ...
            var tab_title = deptName + '全球代购门店详情';
            parent.tab.tabAdd({
                href: 'html/finance/overView/globalShopSale/ngCompanyAreaShop/ngShop.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
