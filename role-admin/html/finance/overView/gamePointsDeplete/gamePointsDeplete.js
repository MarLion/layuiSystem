layui.config({
    ...
    function initRoleLevel() {
        if(roleLevel==0||roleLevel==1){
            href = 'html/finance/overView/platPointsCompany/platPointsCompany.html?integtalType=4&shopId=1';
            name = '分公司';
        }else if(roleLevel==2){
            href = 'html/finance/overView/platPointsCompanyAreaDetail/platPointsCompanyAreaDetail.html?shopId=1&integtalType=4';
            name = '区域';
        }else if(roleLevel==3){
            href='html/finance/overView/platPointsCompanyShopDetail/platPointsCompanyShopDetail.html?shopId=1&integtalType=4';
            name = '门店'
        }
    ...
    $("#goCategory").on('click',function () {
        var time = $("#chooseTime").val();
        parent.tab.tabAdd({
            href: 'html/finance/overView/platPointsCategory/platPointsCategory.html?time='+time+"&integtalType=4",
            // icon: '',
            id:id,
            title: '(游戏消耗)'+categoryName+'积分品类详情'
        })
    });
    //跳转分公司详情
