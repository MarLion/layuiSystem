layui.config({
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        if (obj.event === 'goShopDetails') {
            ...
            var tab_title = decodeURI(goodsName) + "-" + deptName + '-区域详情';
            parent.tab.tabAdd({
                id:tab_id,
            ...
            parent.tab.tabAdd({
                id:tab_id,
                href: 'html/finance/overView/nutritionGuide/ngHistoryReport/ngHistoryReport.html?deptId=' + id + '&goodsno=' + decodeURI(goodsno),
                // icon: '',
                title: tab_title
            });
        }
