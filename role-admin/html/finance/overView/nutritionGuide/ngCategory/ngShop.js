layui.config({
    ...
    var companyTable = table.render({
        elem: '#companyLs',
        url: base.apiUrl() + '/yys/getSaleInfos',
        headers: {
    ...
    $(function () {
        base._ajax({
            url: base.apiUrl() + '/yys/getWeekData',
            data: {
                deptId: deptId
            },
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        if (obj.event === 'goUserDetails') {
            ...
            parent.tab.tabAdd({
                id: tab_id,
                href: 'html/finance/overView/nutritionGuide/ngCategory/ngPerson.html?time=' + time + '&shopId=' + deptId + '&shopName=' + decodeURI(deptName) + '&goodsno=' + decodeURI(goodsno) + '&goodsName=' + decodeURI(goodsName),
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                id: tab_id,
                href: 'html/finance/overView/nutritionGuide/ngHistoryReport/ngHistoryReport.html?deptId=' + id + '&deptName=' + decodeURI(name) + '&goodsno=' + decodeURI(goodsno) + '&goodsName=' + decodeURI(goodsName),
                // icon: '',
                title: tab_title
            });
        }
