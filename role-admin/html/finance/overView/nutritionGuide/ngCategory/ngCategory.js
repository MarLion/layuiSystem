layui.config({
    ...
    var companyTable = table.render({
        elem: '#lsCate',
        url: base.apiUrl() + '/yys/getSaleInfosByGoods',
        headers: {
    ...
    table.on('tool(lsCate)', function (obj) {
        ...
        if (obj.event === 'goRegionalDetails') {
            ...
            var href='html/finance/overView/nutritionGuide/ngCategory/ngCompany.html?time=' + time + '&goodsno=' + goodsno+ '&goodsName=' + decodeURI(goodsName)
            if(2==roleLevel){
                tab_title = goodsName + '区域销售详情';
                href='html/finance/overView/nutritionGuide/ngCategory/ngArea.html?time=' + time + '&deptId=' + deptId+ '&goodsno=' + goodsno+ '&goodsName=' + decodeURI(goodsName)
            }else if(3==roleLevel){
                tab_title = goodsName + '门店销售详情';
                href='html/finance/overView/nutritionGuide/ngCategory/ngShop.html?time=' + time + '&deptId=' + deptId + '&goodsno=' + decodeURI(goodsno) + '&goodsName=' + decodeURI(goodsName)
            }
            parent.tab.tabAdd({
                id: tab_id,
                href: href,
            ...
            parent.tab.tabAdd({
                id: tab_id,
                href: 'html/finance/overView/nutritionGuide/ngHistoryReport/ngHistoryReport.html?deptId=1&deptName=&goodsno=' + decodeURI(goodsno),
                // icon: '',
                title: tab_title
            });
        }
