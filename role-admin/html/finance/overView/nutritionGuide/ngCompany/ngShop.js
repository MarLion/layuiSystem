layui.config({
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        if (obj.event === 'goUserDetails') {
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/nutritionGuide/ngCompany/ngPerson.html?time='+ time+'&deptId='+deptId,
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/nutritionGuide/ngHistoryReport/ngHistoryReport.html?deptId='+ id,
                // icon: '',
                title: tab_title
            });
        }
