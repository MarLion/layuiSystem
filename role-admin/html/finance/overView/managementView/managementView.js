layui.config({
    ...
    function chartInit() {
        ...
        base._ajax({
            ...
            data:{
                ...
                viewId:'1',
                parameters:"{'deptId': "+ 2 +",'startTime':"+startTime+",'endTime':"+endTime+"}"
            },
            headers:{
    ...
    var totalOverTable = table.render({
        ...
        where:{
            ...
            parameters:"{'searchTime': "+ searchTime +",'deptId':"+2+"}"
        },
        ...
        cols:[[
            ...
            , {field: 'xlMoney',width:150,align:'center', title: '玄乐管理总额'}
            ...
            , {field: 'status', width:250,title: '操作',fixed:'right',templet:function (d) {
                var  str ='  <a class="layui-btn layui-btn-xs layui-btn-normal" src="javaScript:void(0)" lay-event="detail">详情</a>'+
                    '<a class="layui-btn layui-btn-xs layui-btn-normal" src="javaScript:void(0)" lay-event="subCompayTotalTable">分公司总账列表</a>'
                return str;
    ...
    table.on('tool(totalOver)', function (obj) {
        ...
        var deptId = 1
        //分公司列表
        if (layEvent === 'subCompayTotalTable') {
            parent.tab.tabAdd({

                href: 'html/finance/overView/managementView/managementViewSubCompany/managementViewSubCompany.html?searchTime='+searchTime+'&deptId='+deptId,
                // icon: '',
                title: '分公司积分详情'
            })
