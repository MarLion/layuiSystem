layui.config({
        ...
        cols:[[
            ...
            , {field: 'status',width:250,align:'center', title: '操作',fixed:'right',templet:function (d) {
                var  str ='  <a class="layui-btn layui-btn-xs layui-btn-normal" src="javaScript:void(0)" lay-event="detail">详情</a>'+
                    '<a class="layui-btn layui-btn-xs layui-btn-normal" src="javaScript:void(0)" lay-event="shopTotalTable">门店总账列表</a>'
                return str;
    ...
    table.on('tool(totalOver)', function (obj) {
        ...
        //查看分公司详情
        if (layEvent === 'shopTotalTable') {
            parent.tab.tabAdd({

                href: 'html/finance/overView/managementView/managementViewShop/managementViewShop.html?searchTime='+time+'&deptId='+deptId,
                // icon: '',
                id:deptId,
                title: name
            })
            ...
            parent.tab.tabAdd({
                ...
                href: 'html/finance/overView/managementView/managementViewDetail/managementViewDetail.html?time='+time+'&deptId='+deptId,
                id:deptId,
                title: name1
            })
        }
