layui.config({
    ...
    table.on('tool(areaLs)', function (obj) {
        ...
        if (obj.event === 'goShopDetails') {
            ...
            var tab_title = deptName + '附近小店门店详情';
            parent.tab.tabAdd({
                href: 'html/finance/overView/nearShopSale/ngCompanyAreaShop/ngShop.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
