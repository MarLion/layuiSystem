layui.config({
    ...
    $("#goCompany").on('click',function () {
        ...
        if(roleLevel==2){
            title='附近小店区域销售详情';
            href='html/finance/overView/nearShopSale/ngCompanyArea/ngArea.html?time='+ time+'&deptId=-1';
        }else if(roleLevel==3){
            title='附近小店门店销售详情';
            href='html/finance/overView/nearShopSale/ngCompanyAreaShop/ngShop.html?time='+ time+'&deptId=-1';
        }else{
            title='附近小店分公司销售详情';
            href='html/finance/overView/nearShopSale/ngCompany/ngCompany.html?time='+ time;
        }
        parent.tab.tabAdd({
            href: href,
            // icon: '',
    ...
    function ridgePovertyData(){
        ...
        base._ajax({
            url:base.apiUrl()+'/nearShop/getSaleTotalInfos',
            data:{
                searchTime:time,
            },
    ...
    function ridgePovertyEcharts() {
        var m = base.show_load_layer(); //loading层
        base._ajax({
            url:base.apiUrl()+'/nearShop/getChartData',
            data:{
                deptId:'1'
            },
            success:function (res) {
    ...
    function ridgePovertyEchartsSearch() {
        ...
        var m = base.show_load_layer(); //loading层
        base._ajax({
            url:base.apiUrl()+'/nearShop/getChartDataByData',
            data:{
                deptId:'1',
                startTime:begindate,
                endTime:enddate,
