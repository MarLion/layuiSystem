layui.config({
    ...
    var shopTable = table.render({
        elem:'#shopLs',
        url: base.apiUrl()+'/nearShop/getSaleInfos',
        headers:{
    ...
    $(function(){
        base._ajax({
            url: base.apiUrl()+'/nearShop/getWeekData',
            data:{
                deptId:deptId
            },
    ...
    table.on('tool(shopLs)', function (obj) {
        ...
        if (obj.event === 'goMemberDetails') {
            ...
            var tab_title = deptName + '附近小店个人销售情况';
            parent.tab.tabAdd({
                href: 'html/finance/overView/nearShopSale/ngCompanyAreaShopMember/ngMember.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/nearShopSale/ngHistoryReport/ngHistoryReport.html?deptId='+ deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
        }
