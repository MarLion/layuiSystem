layui.config({
    ...
    var companyTable = table.render({
        ...
        where:{
            ...
            viewId: '1',
            parameters:"{'deptId': " + 1 + ", 'time': " + $("#chooseTime").val() + ", 'type': " + 15 + "}"
        },
        cellMinWidth: 60,
        ...
        cols: [[
            ...
            {field: 'daynum',align: 'center', title: '玄乐专享转出总额'},
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        if (obj.event === 'goRegionalDetails') {
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/xuanleVipOut/vipOutCompanyArea/vipOutArea.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
