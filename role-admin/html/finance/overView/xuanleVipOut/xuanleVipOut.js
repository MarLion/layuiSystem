layui.config({
    ...
    $("#goCompany").on('click',function () {
        ...
        if(roleLevel==1||roleLevel==0){
            hrefUrl='html/finance/overView/xuanleVipOut/vipOutCompany/vipOutCompany.html?time='+ time
        }else if(roleLevel==2){
            hrefUrl='html/finance/overView/xuanleVipOut/vipOutCompanyArea/vipOutArea.html?time='+ time+'&deptId=1'+'&deptName=';
        }else if(roleLevel==3){
            hrefUrl='html/finance/overView/xuanleVipOut/vipOutCompanyAreaShop/vipOutShop.html?time='+ time+'&deptId=1'+'&deptName=';
        }
        parent.tab.tabAdd({
            href: hrefUrl,
            title: '分公司玄乐专享转出'
    ...
    function ridgePovertyData(){
        ...
        base._ajax({
            ...
            data: {
                ...
                viewId: '1',
                parameters: "{'deptId': " + 1 + ", 'time': " + time + ", 'type': " + 15 + "}"
            },
            headers: {
    ...
    function ridgePovertyEchartsSearch() {
        ...
        base._ajax({
            ...
            data: {
                ...
                viewId: '1',
                parameters: "{'deptId': " + 1 + ", 'begindate': " + begindate + ", 'enddate': " + enddate + ", 'type': " + 15 + "}"
            },
            headers: {
                'xxl_sso_sessionid': window.sessionStorage.getItem('sessionid'),
                'Content-Type': "application/x-www-form-urlencoded; charset=UTF-8",
