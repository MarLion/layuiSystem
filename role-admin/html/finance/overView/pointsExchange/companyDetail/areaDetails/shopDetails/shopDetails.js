layui.config({
    ...
    var companyTable = table.render({
        ...
        where: {
            ...
            viewId: '1',
            parameters: "{'deptId': "+ id +", 'time': " + $("#chooseTime").val() + "}"
        },
        method: 'post',
        ...
        cols: [[
            ...
            {field: 'totalMoney', title: '服务费总额'},
            {field: 'avgWeekMoney', title: '周平均服务费'},
    ...
    $("#check").on('click', function () {
        ...
        companyTable.reload({
            where: {
                actionName: 'com.xguanjia.client.action.statistics.saleManage.ServiceChargeAction$getMoneyInfo',
                viewId: '1',
                parameters: "{'deptId': "+ id +", 'time': " + time + "}"
            }
        })
    ...
    table.on('tool(companyPc)', function (obj) {
        ...
        if (obj.event === 'goShopDetails') {
            ...
            var tab_title = name + '服务人详情';
            parent.tab.tabAdd({
                href: 'html/finance/overView/pointsExchange/companyDetail/areaDetails/shopDetails/shopServiceFeeDetails/shopServiceFeeDetails.html?time='+time+"&id="+id,
                // icon: '',
                title: tab_title
            });
