layui.config({
    ...
    table.on('tool(shopLs)', function (obj) {
        ...
        if (obj.event === 'goMemberDetails') {
            ...
            var tab_title = deptName + '直播个人销售情况';
            parent.tab.tabAdd({
                href: 'html/finance/overView/liveManage/ngCompanyAreaShopMember/ngMember.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
