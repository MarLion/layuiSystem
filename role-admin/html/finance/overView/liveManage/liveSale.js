layui.config({
    ...
    $("#goCompany").on('click',function () {
        ...
        if(roleLevel==2){
            title='直播区域销售详情';
            href='html/finance/overView/liveManage/ngCompanyArea/ngArea.html?time='+ time+'&deptId=-1';
        }else if(roleLevel==3){
            title='直播门店销售详情';
            href='html/finance/overView/liveManage/ngCompanyAreaShop/ngShop.html?time='+ time+'&deptId=-1';
        }else{
            title='直播分公司销售详情';
            href='html/finance/overView/liveManage/ngCompany/ngCompany.html?time='+ time;
        }
        parent.tab.tabAdd({
            href: href,
            // icon: '',
    ...
    function ridgePovertyData(){
        ...
        base._ajax({
            url:base.apiUrl()+'/live/getSaleTotalInfos',
            data:{
                searchTime:time,
            },
