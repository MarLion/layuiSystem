layui.config({
    ...
    var companyTable = table.render({
        ...
        cols:[[
            ...
            ,{field:'status',title:'操作',align:'center',width:320,templet: function (e) {
                ...
                var  str ='  <a class="layui-btn layui-btn-normal layui-btn-xs" src="javaScript:void(0)" lay-event="shopDetail">门店</a>'
                return str;
            }}
        ]],
    ...
    table.on('tool(areaLs)', function (obj) {
        ...
        var name = prefixName+deptName+"所属门店积分详情"
        //查看分公司详情
        if (layEvent === 'shopDetail') {
            parent.tab.tabAdd({

                href: 'html/finance/overView/platPointsCompanyShopDetail/platPointsCompanyShopDetail.html?time='+time+'&shopId='+shopId+"&integtalType="+integtalType,
                // icon: '',
                id:id,
                title: name
            })
