layui.config({
    ...
    var areaTable = table.render({
        ...
        cols: [[
            ...
            {field: 'daynum',align: 'center', title: '新增会员'},
    ...
    table.on('tool(areaLs)', function (obj) {
        ...
        if (obj.event === 'goRegionalDetails') {
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/peopleSignNum/ngCompanyArea/ngArea.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(shopName),
                title: tab_title
            });
