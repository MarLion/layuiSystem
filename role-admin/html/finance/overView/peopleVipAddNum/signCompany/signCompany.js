layui.config({
    ...
    var companyTable = table.render({
        ...
        where:{
            ...
            parameters:'{"time":'+time+',"deptId":1,"type":5}',
        },
    ...
    $("#check").on('click',function () {
        ...
        companyTable.reload({
            where:{
                actionName:'com.xguanjia.client.action.statistics.memberstatistics.MemberstatisticsAction$getSaleInfos',
                parameters:'{"time":'+$("#chooseTime").val()+',"deptId":1,"type":5}',
            },
        })
    });
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        if (obj.event === 'goRegionalDetails') {
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/peopleVipAddNum/ngCompanyArea/ngArea.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(shopName),
                title: tab_title
            });
