layui.config({
    ...
    var areaTable = table.render({
        ...
        cols: [[
            ...
            {field: 'shopName', align: 'center',title: '区域名'},
    ...
    table.on('tool(areaLs)', function (obj) {
        ...
        if (obj.event === 'goShopDetails') {
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/peopleEquiAddNum/equiCompanyAreaShop/equiShop.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
