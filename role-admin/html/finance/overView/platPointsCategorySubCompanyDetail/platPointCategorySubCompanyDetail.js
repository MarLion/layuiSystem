layui.config({
    ...
    var companyTable = table.render({
        ...
        cols:[[
            ...
            ,{field:'status',title:'操作',align:'center',width:320,templet: function (e) {
                ...
                var  str ='  <a class="layui-btn layui-btn-xs" src="javaScript:void(0)" lay-event="branchCompanyDetail">区域</a>'
                return str;
            }}
        ]],
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        var name = deptName+"所属区域积分品类详情";
        var id = type+shopId;
        //查看分公司详情
        if (layEvent === 'branchCompanyDetail') {
            parent.tab.tabAdd({

                href: 'html/finance/overView/platPointsCategoryAreaDetail/platPointsCategoryAreaDetail.html?time='+time+'&shopId='+shopId+'&type='+type+"&category="+category,
                // icon: '',
                id:id,
                title: name
            })
