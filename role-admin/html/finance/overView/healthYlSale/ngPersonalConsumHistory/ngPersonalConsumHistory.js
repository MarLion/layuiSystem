        ...
        base._ajax({
            ...
            success: function (res) {
                ...
                for (var j = 0; j < nearShopList.length; j++) {
                    service6 += '<tr>';
                    service6 += '<td>' + saleType+ '</td><td>' + nearShopList[j].name + '</td><td>' + nearShopList[j].num + '</td><td>' + nearShopList[j].total + '</td>';
                    service6 += '</tr>';
                }
                ...
                for (var j = 0; j < hnList.length; j++) {
                    service7 += '<tr>';
                    service7 += '<td>' + saleType + '</td><td>' + hnList[j].name + '</td><td>' + hnList[j].num + '</td><td>' + hnList[j].total + '</td>';
                    service7 += '</tr>';
                }
                ...
                for (var j = 0; j < yyzdList.length; j++) {
                    service8 += '<tr>';
                    service8 += '<td>' + saleType + '</td><td>' + yyzdList[j].name + '</td><td>' + yyzdList[j].num + '</td><td>' + yyzdList[j].total + '</td>';
                    service8 += '</tr>';
                }
