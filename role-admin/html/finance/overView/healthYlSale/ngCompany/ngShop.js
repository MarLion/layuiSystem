layui.config({
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        if (obj.event === 'goUserDetails') {
            ...
            var tab_title = deptName + '门店详情';
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthYlSale/ngCompany/ngPerson.html?time='+ time+'&deptId='+deptId,
                // icon: '',
                title: tab_title
            });
            ...
            var tab_title = name + '历史销售报表';
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthYlSale/ngHistoryReport/ngHistoryReport.html?deptId='+ id,
                // icon: '',
                title: tab_title
            });
        }
