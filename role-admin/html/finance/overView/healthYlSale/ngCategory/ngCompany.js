layui.config({
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        if (obj.event === 'goRegionalDetails') {
            ...
            var tab_title = '';
            tab_title += goodsName + "-" + deptName + '详情';
            parent.tab.tabAdd({
                id: tab_id,
                href: 'html/finance/overView/healthYlSale/ngCategory/ngArea.html?time=' + time + '&deptId=' + deptId+ '&goodsno=' + decodeURI(goodsno)+ '&goodsName=' + decodeURI(goodsName),
                // icon: '',
                title: tab_title
            });
            ...
            var tab_title = goodsName + "-" + name + '-历史销售报表';
            parent.tab.tabAdd({
                id: tab_id,
                href: 'html/finance/overView/healthYlSale/ngHistoryReport/ngHistoryReport.html?deptId=' + id+ '&goodsno=' + decodeURI(goodsno),
                // icon: '',
                title: tab_title
            });
        }
