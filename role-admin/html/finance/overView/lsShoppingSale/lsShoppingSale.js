layui.config({
    ...
    $("#goCategory").on('click', function () {
        ...
        var href=''
        if(roleLevel==2){
            href='html/finance/overView/lsShoppingSale/lsCategory/lsCategory.html?time=' + time+ '&deptId=-1';
        }else if(roleLevel==3){
            href='html/finance/overView/lsShoppingSale/lsCategory/lsCategory.html?time=' + time+ '&deptId=-1';
        }else{
            href='html/finance/overView/lsShoppingSale/lsCategory/lsCategory.html?time=' + time+ '&deptId=1';
    ...
    $("#goCompany").on('click', function () {
        ...
        var title = "";
        if (roleLevel == 2) {
            href = 'html/finance/overView/lsShoppingSale/isRegion/isRegion.html?deptId=-1&time=' + time;
            title = '垄上扶贫区域销售详情';
        }else if (roleLevel == 3) {
            href = 'html/finance/overView/lsShoppingSale/isStore/isStore.html?deptId=-1&time=' + time;
            title = '垄上扶贫门店销售详情';
        }else {//0、1
            href = 'html/finance/overView/lsShoppingSale/lsCompany/lsCompany.html?time=' + time;
            title = '垄上扶贫分公司销售详情';
        }
        parent.tab.tabAdd({
            href: href,
    ...
    function ridgePovertyData() {
        ...
        base._ajax({
            url: base.apiOthUrl(),
            data: {
                actionName: 'com.xguanjia.client.action.statistics.saleManage.GroupAction$getSaleTotalInfos',
                viewId: '1',
                parameters: "{'searchTime': " + time + ", 'type': '0'}"
            },
            headers: {
    ...
    function ridgePovertyEcharts() {
        ...
        base._ajax({
            url: base.apiOthUrl(),
            data: {
                actionName: 'com.xguanjia.client.action.statistics.saleManage.GroupAction$getChartData',
                viewId: '1',
                parameters: "{'deptId': '1', 'type': '0'}"
            },
            headers: {
                'xxl_sso_sessionid': window.sessionStorage.getItem('sessionid'),
                'Content-Type': "application/x-www-form-urlencoded; charset=UTF-8",
    ...
    function ridgePovertyEchartsSearch() {
        ...
        base._ajax({
            url: base.apiOthUrl(),
            data: {
                actionName: 'com.xguanjia.client.action.statistics.saleManage.GroupAction$searchOrder',
                viewId: '1',
                parameters: "{'deptId': '1', 'type': '0', 'begindate': " + begindate + ", 'enddate': " + enddate + "}"
            },
            headers: {
                'xxl_sso_sessionid': window.sessionStorage.getItem('sessionid'),
                'Content-Type': "application/x-www-form-urlencoded; charset=UTF-8",
