layui.config({
    ...
    table.on('tool(companyPc)', function (obj) {
        ...
        if (obj.event === 'goSalePinLeiDetails') {
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpSubCompanyDetails/subCompanyPinLeiSaleDetails/scplSaleDetails.html?' +
                    'deptId='+id+"&time="+time,
                // icon: '',
                title: tab_title
            });
            ...
            var tab_title = name + '销售详情';
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpSubCompanyDetails/subCompanySaleDetails/scSaleDetails.html?' +
                    'deptId='+id+"&time="+time,
                // icon: '',
                title: tab_title
            });
