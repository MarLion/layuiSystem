layui.config({
    ...
    var companyTable = table.render({
        ...
        where: {
            actionName: 'com.xguanjia.client.action.statistics.saleManage.ProductStaAction$getSaleInfos',
            viewId: '1',
        ...
        cols: [[
            ...
            {field: 'right', align: 'center', width: 350, toolbar: '#barDemo', title: '操作'}
        ]],
        skin: 'line', //表格风格
        even: true,
        limit: 15, //每页默认显示的数量
    ...
    $(function () {
        base._ajax({
            url: base.apiOthUrl(),
            data: {
                actionName: 'com.xguanjia.client.action.statistics.saleManage.ProductStaAction$getWeekData',
                viewId: '1',
    ...
    table.on('tool(companyPc)', function (obj) {
        var data = obj.data;
        if (obj.event === 'goSalePinLeiDetails') {
            var id = data.id;
            ...
            var tab_title = name + '销售品类详情';
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpSubCompanyDetails/shopPinLeiDetails/splDetails.html?' +
                    'deptId='+id+"&time="+time,
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpSubCompanyDetails/historyReport/hReport.html?deptId='+id,
                // icon: '',
                title: tab_title
            });
            ...
            var tab_title = name + '销售详情';
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpSubCompanyDetails/shopSaleDetails/ssDetails.html?' +
                    'deptId='+id+"&time="+time,
                // icon: '',
                title: tab_title
            });
