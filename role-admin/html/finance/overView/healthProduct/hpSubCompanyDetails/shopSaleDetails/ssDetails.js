layui.config({
    ...
    var companyTable = table.render({
        ...
        where: {
            ...
            viewId: '1',
            parameters: "{'deptId':"+ deptId +",'searchTime':'" + time + "'}"
        },
        method: 'post',
    ...
    table.on('tool(companyPc)', function (obj) {
        ...
        if (obj.event === 'goShopDetails') {
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpSubCompanyDetails/memberConsumeOrder/mcOrder.html?' +
                    "time="+time+"&id="+id+"&address="+address,
                // icon: '',
                title: tab_title
            });
        }
