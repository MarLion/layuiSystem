layui.config({
    ...
    table.on('tool(companyPc)', function (obj) {
        ...
        if (obj.event === 'goSalePinLeiDetails') {
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpSubCompanyDetails/areaPinLeiDetails/aplDetails.html?' +
                    'deptId='+id+"&time="+time,
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpSubCompanyDetails/areaSaleDetails/asDetails.html?' +
                    'deptId='+id+"&time="+time,
                // icon: '',
                title: tab_title
            });
