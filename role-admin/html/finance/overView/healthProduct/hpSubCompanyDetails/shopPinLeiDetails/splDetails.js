layui.config({
    ...
    table.on('tool(companyPc)', function (obj) {
        ...
        if (obj.event === 'goSubCompanyDetails') {
            ...
            var tab_title = "员工销售订单";
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpPinLeiDetails/shopSaleDetails/sSaleDetails.html?' +
                    'id='+deptId+'&time='+time+"&goodsno="+goodsno+"&goodsname="+goodsname,
                // icon: '',
                title: tab_title
            });
