layui.config({
    ...
    table.on('tool(companyPc)', function (obj) {
        ...
        if (obj.event === 'goSubCompanyDetails') {
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpPinLeiDetails/productSubCompanySaleList/pscSaleList.html?time='+time+"&goodsno="+goodsno+"&goodsname="+goodsname,
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpPinLeiDetails/productHistoryReport/phReport.html?goodsno='+goodsno,
                // icon: '',
                title: tab_title
            });
        }
