layui.config({
    ...
    table.on('tool(companyPc)', function (obj) {
        ...
        if (obj.event === 'goHistoryReport') {
            ...
            var deptName = data.deptName;
            var tab_title = deptName + '销售详情';
            parent.tab.tabAdd({
                href: 'html/finance/overView/healthProduct/hpPinLeiDetails/areaSaleDetails/aSaleDetails.html?' +
                    'deptId='+id+"&time="+time+"&goodsno="+goodsno+"&goodsname="+goodsname,
                // icon: '',
                title: tab_title
            });
        }
