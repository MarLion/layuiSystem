layui.config({
    ...
    table.on('tool(shopLs)', function (obj) {
        ...
        if (obj.event === 'goMemberDetails') {
            ...
            var tab_title = deptName + '充值个人情况';
            parent.tab.tabAdd({
                href: 'html/finance/overView/recharge/ngCompanyAreaShopMember/ngMember.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
