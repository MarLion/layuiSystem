layui.config({
    ...
    var companyTable = table.render({
        ...
        where:{
            ...
            viewId: '1',
            parameters:"{'deptId': " + 1 + ", 'time': " + $("#chooseTime").val() + ", 'type': " + 14 + "}"
        },
        cellMinWidth: 60,
        ...
        cols: [[
            ...
            {field: 'daynum',align: 'center', title: '玄乐专享转入总额'},
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        if (obj.event === 'goRegionalDetails') {
            ...
            var tab_title = deptName + '玄乐专享转入';
            parent.tab.tabAdd({
                href: 'html/finance/overView/xuanleVipIn/vipCompanyArea/vipArea.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
            ...
            var deptId = data.shopId;
            var deptName =data.shopName;
            var tab_title = deptName + '往期玄乐专享转入报表';
            parent.tab.tabAdd({
                href: 'html/finance/overView/xuanleVipIn/vipHistoryReport/vipHistoryReport.html?deptId='+ deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
        }
