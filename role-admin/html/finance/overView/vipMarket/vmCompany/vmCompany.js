layui.config({
    ...
    var companyTable = table.render({
        ...
        where: {
            ...
            viewId: '1',
            parameters: "{'deptId': '1', 'searchTime': " + $("#chooseTime").val() + ",'type': '1'}"
        },
        method: 'post',
    ...
    $("#check").on('click', function () {
        ...
        companyTable.reload({
            where: {
                actionName: 'com.xguanjia.client.action.statistics.saleManage.GroupAction$getSaleInfos',
                viewId: '1',
                parameters: "{'deptId': '1', 'searchTime': " + time + ",'type': '1'}"
            }
        })
    });
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        if (obj.event === 'goRegionalDetails') {
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/vipMarket/vmRegion/vmRegion.html?deptId=' + id + '&time=' + time,
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/vipMarket/vmHistoryReport/vmHistoryReport.html?deptId=' + id,
                // icon: '',
                title: tab_title
            });
            ...
            var tab_title = name + '专享商城品类销售详情';
            parent.tab.tabAdd({
                id: tab_id,
                href: 'html/finance/overView/vipMarket/vmCategory/vmCategory.html?deptId='+id+'&time=' + time + '&name=' + encodeURI(name),
                // icon: '',
                title: tab_title
            });
        }
