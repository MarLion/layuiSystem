layui.config({
    ...
    var cateTable = table.render({
        ...
        cols: [[
            ...
            {field: 'weekSaleMoney', title: '本周平均销售额'},
            {field: 'monthSaleMoney', title: '本月平均销售额'},
            {
                field: 'todayRise', title: '同比昨日增长', templet: '#todayRise', templet: function (d) {
                    var obj = changColor(d.todayPercent);
                    var _html = '<span>' + d.todayRise + '</span><span class="ml10"><img src="'+obj.src+'"/></imh></span><span class="ml10 '+obj.class+'">' + d.todayPercent + '</span>';
                    return _html;
                }
            },
            {
    ...
    $("#check").on('click', function () {
        ...
        cateTable.reload({
            where: {
                actionName: 'com.xguanjia.client.action.statistics.saleManage.GroupAction$getSaleInfosByGoods',
                viewId: '1',
                parameters: "{'deptId': "+deptId+", 'searchTime': " + time + ",'type': '1'}"
            }
        })
    })
    ...
    table.on('tool(lsCate)', function (obj) {
        ...
        if (obj.event === 'goCompanyDetails') {
            ...
            parent.tab.tabAdd({
                id: tab_id,
                href: 'html/finance/overView/vipMarket/vmCompanyCategory/vmCompanyCategory.html?deptId=1&time=' + time + '&goodsno=' + goodsno + '&goodsname=' + encodeURI(name),
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                id: tab_id,
                href: 'html/finance/overView/vipMarket/vmCategoryHistoryReport/vmCategoryHistoryReport.html?deptId=1&goodsno=' + goodsno,
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/vipMarket/vmRegionCategory/vmRegionCategory.html?deptId=' + deptId + '&time=' + time + '&goodsno=' + goodsno + '&goodsname=' + encodeURI(name),
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/vipMarket/vmStoreCategory/vmStoreCategory.html?deptId=' + deptId + '&time=' + time + '&goodsno=' + goodsno + '&goodsname=' + encodeURI(name),
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/vipMarket/vmPersonalCategory/vmPersonalCategory.html?deptId=' + deptId + '&time=' + time + '&goodsno=' + goodsno + '&goodsname=' + encodeURI(name),
                // icon: '',
                title: tab_title
            });
        }
