layui.config({
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        if (obj.event === 'goStoreDetails') {
            ...
            var tab_title = name + '门店详情';
            parent.tab.tabAdd({
                href: 'html/finance/overView/vipMarket/vmStore/vmStore.html?deptId=' + id + '&time=' + time,
                // icon: '',
                title: tab_title
            });
