layui.config({
    ...
    $("#goCategory").on('click', function () {
        ...
        var href=''
        if(roleLevel==2){
            href='html/finance/overView/vipMarket/vmCategory/vmCategory.html?time=' + time+ '&deptId=-1';
        }else if(roleLevel==3){
            href='html/finance/overView/vipMarket/vmCategory/vmCategory.html?time=' + time+ '&deptId=-1';
        }else{
            href='html/finance/overView/vipMarket/vmCategory/vmCategory.html?time=' + time+ '&deptId=1';
    ...
    $("#goCompany").on('click', function () {
        ...
        var title = "";
        if (roleLevel == 2) {
            href = 'html/finance/overView/vipMarket/vmRegion/vmRegion.html?deptId=-1&time=' + time;
            title = '专享商城区域销售详情';
        }else if (roleLevel == 3) {
            href = 'html/finance/overView/vipMarket/vmStore/vmStore.html?deptId=-1&time=' + time;
            title = '专享商城门店销售详情';
        }else {//0、1
            href = 'html/finance/overView/vipMarket/vmCompany/vmCompany.html?time=' + time;
            title = '专享商城分公司销售详情';
        }
        parent.tab.tabAdd({
            href: href,
    ...
    function ridgePovertyData() {
        ...
        base._ajax({
            ...
            data: {
                ...
                viewId: '1',
                parameters: "{'searchTime': " + time + ", 'type': '1'}"
            },
            headers: {
    ...
    function ridgePovertyEchartsSearch() {
        ...
        base._ajax({
            ...
            data: {
                ...
                viewId: '1',
                parameters: "{'deptId': '1', 'type': '1', 'begindate': " + begindate + ", 'enddate': " + enddate + "}"
            },
            headers: {
                'xxl_sso_sessionid': window.sessionStorage.getItem('sessionid'),
                'Content-Type': "application/x-www-form-urlencoded; charset=UTF-8",
