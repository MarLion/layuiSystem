layui.config({
    ...
    var shopTable = table.render({
        elem:'#shopLs',
        url: base.apiUrl()+'/hn/getSaleInfos',
        headers:{
    ...
    $(function(){
        base._ajax({
            url: base.apiUrl()+'/hn/getWeekData',
            data:{
                deptId:deptId
            },
    ...
    table.on('tool(shopLs)', function (obj) {
        ...
        if (obj.event === 'goMemberDetails') {
            ...
            var tab_title = deptName + '相亲交友个人销售情况';
            parent.tab.tabAdd({
                href: 'html/finance/overView/blindDate/ngCompanyAreaShopMember/ngMember.html?time='+ time+'&deptId='+deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
            ...
            parent.tab.tabAdd({
                href: 'html/finance/overView/blindDate/ngHistoryReport/ngHistoryReport.html?deptId='+ deptId+'&deptName='+encodeURI(deptName),
                // icon: '',
                title: tab_title
            });
        }
