layui.config({
        ...
        cols:[[
            ...
            ,{field:'status',title:'操作',align:'center',width:320,templet: function (e) {
                ...
                var  str ='  <a class="layui-btn layui-btn-normal layui-btn-xs" src="javaScript:void(0)" lay-event="gameCategoryDetail">游戏类别收益详情</a>'+
                    ...
                    '  <a class="layui-btn layui-btn-normal layui-btn-xs" src="javaScript:void(0)" lay-event="areaDetail">区域详情</a>'
                return str;
            }}
        ]],
    ...
    table.on('tool(companyLs)', function (obj) {
        ...
        }else if(layEvent==='areaDetail'){//区域详情
            parent.tab.tabAdd({

                href: 'html/finance/overView/xuanleGame/xgArea/xgArea.html?time='+time+'&deptId='+deptId,
                // icon: '',
                id:deptId,
                title: name3
            })
